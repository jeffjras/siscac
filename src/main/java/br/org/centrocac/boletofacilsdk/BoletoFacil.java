package br.org.centrocac.boletofacilsdk;

import org.apache.commons.lang3.StringUtils;

import br.org.centrocac.boletofacilsdk.enums.BoletoFacilEnvironment;
import br.org.centrocac.boletofacilsdk.enums.RequestType;
import br.org.centrocac.boletofacilsdk.enums.ResponseType;
import br.org.centrocac.boletofacilsdk.exceptions.BoletoFacilTokenException;
...
import br.org.centrocac.boletofacilsdk.model.entities.Split;
import br.org.centrocac.boletofacilsdk.model.entities.Transfer;
import br.org.centrocac.boletofacilsdk.model.request.ListChargesDates;
import br.org.centrocac.boletofacilsdk.model.response.CancelChargeResponse;
import br.org.centrocac.boletofacilsdk.model.response.ChargeResponse;
import br.org.centrocac.boletofacilsdk.model.response.FeeSchemaResponse;
import br.org.centrocac.boletofacilsdk.model.response.FetchBalanceResponse;
import br.org.centrocac.boletofacilsdk.model.response.ListChargesResponse;
import br.org.centrocac.boletofacilsdk.model.response.PayeeResponse;
import br.org.centrocac.boletofacilsdk.model.response.TransferResponse;
...
public class BoletoFacil extends BoletoFacilBase {
	...
	private void addIssueChargeParameters(StringBuilder requestUri, Charge charge) {
		...
		addUriParameter(requestUri, "referralToken", charge.getReferralToken());
		...
		addUriParameter(requestUri, "creditCardStore", charge.getCreditCardStore());
		addUriParameter(requestUri, "creditCardId", charge.getCreditCardId());
