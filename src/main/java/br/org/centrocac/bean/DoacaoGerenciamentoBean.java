...
@ManagedBean
@ViewScoped
public class DoacaoGerenciamentoBean {
    ...
    public void init() {
        ...
        this.listarDoacoesPorColaborador();
    }

    public void listarDoacoesPorColaborador() {
        doacoes = doacaoRN.obterDoacoesPorColaborador(colaborador);
    }
